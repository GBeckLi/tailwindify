...
var angularJsonPath = path_1.default.resolve('./angular.json');
var angularJson;
var targetProject;
var targetProjectName = '';
function getAngularJson() {
    var content = shelljs_1.default.cat(angularJsonPath);
    if (content.code !== 0) {
...
exports.choiceProject = choiceProject;
function getRootpath() {
    return targetProject ? targetProject.root : path_1.default.resolve(__dirname, '');
}
...
exports.getTargetProjectName = getTargetProjectName;
